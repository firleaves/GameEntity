...
namespace GameEntity
{
    ...
    internal sealed class IdGenerator
    {
        ...
        public IdGenerator(TimeInfo timeInfo)
        {
            _timeInfo = timeInfo ?? throw new ArgumentNullException(nameof(timeInfo));
        }
        ...
        {
            uint a = (uint)((_timeInfo.FrameTime - this._epoch2022) / 1000);
            return a;
        }
